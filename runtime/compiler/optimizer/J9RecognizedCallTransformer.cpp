...
void J9::RecognizedCallTransformer::process_java_lang_StringCoding_encodeASCII(TR::TreeTop* treetop, TR::Node* node)
   ...
   */
   ...
   TR::Node *newInputNode = TR::TransformUtil::generateArrayStartTrees(comp(), sourceArrayNode);
   TR::Node *newOutputNode = TR::TransformUtil::generateArrayStartTrees(comp(), destinationArrayNode);
