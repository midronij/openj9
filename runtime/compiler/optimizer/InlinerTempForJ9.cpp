...
TR_J9InlinerPolicy::genCodeForUnsafeGetPut(TR::Node* unsafeAddress,
   ...
   if (checksNeeded || arrayBlockNeeded) // CASES (1), (2), (3)
      {
      TR::Node *addrLoad =
         TR::Node::createWithSymRef(unsafeAddress,
                        comp()->il.opCodeForDirectLoad(unsafeAddress->getDataType()),
...
When the type of the object is unknown at compile time, several runtime checks will be
...
in use, we generate following sequence of tests: we generate following sequence of tests:
...
TR_J9InlinerPolicy::createUnsafePutWithOffset(TR::ResolvedMethodSymbol *calleeSymbol, TR::ResolvedMethodSymbol *callerSymbol, TR::TreeTop * callNodeTreeTop, TR::Node * unsafeCall, TR::DataType type, bool isVolatile, bool needNullCheck, bool isOrdered)
   ...
   // 3.) Object type is known at compile time to be one of the interface classes java/lang/Cloneable or java/io/Serializable
   bool objTypeUnknown = objTypeSig == NULL || strncmp(objTypeSig, "Ljava/lang/Object;", strlen("Ljava/lang/Object;")) == 0
                                            || strncmp(objTypeSig, "Ljava/lang/Cloneable;", strlen("Ljava/lang/Cloneable;")) == 0
                                            || strncmp(objTypeSig, "Ljava/io/Serializable;", strlen("Ljava/io/Serializable;")) == 0;
   ...
   bool checksNeeded = objTypeUnknown || (strncmp(objTypeSig, "Ljava/lang/Class;", strlen("Ljava/lang/Class;")) == 0);
   ...
   // - javaLangClass == NULL
   // - offheap is enabled
   bool arrayCheckNeeded = checksNeeded && arrayBlockNeeded && (conversionNeeded || javaLangClass == NULL || (TR::Compiler->om.isOffHeapAllocationEnabled() && comp()->target().is64Bit()));
   ...
   if (conversionNeeded && (arrayCheckNeeded|| arrayBlockNeeded))
...
TR_J9InlinerPolicy::createUnsafeCASCallDiamond( TR::TreeTop *callNodeTreeTop, TR::Node *callNode)
   ...
   bool arrayCheckNeeded = TR::Compiler->om.isOffHeapAllocationEnabled() && comp()->target().is64Bit() && objTypeUnknown;
