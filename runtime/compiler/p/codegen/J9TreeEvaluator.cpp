   ...
   if (comp->getSymRefTab()->isNonHelper(node->getSymbolReference(), TR::SymbolReferenceTable::singlePrecisionSQRTSymbol))
      ...
      case TR::sun_misc_Unsafe_setMemory:
         if (comp->canTransformUnsafeSetMemory())
            ...
            //     can be calculated at compile time as dest += destOffset. The IL node passed in to setmemoryEvaluator will have three 
            ...
            //     destination address can be calculated at compile time as dest += destOffset. Similar to case (1), the IL node passed
            //     in to setmemoryEvaluator() will have three children: dest, len, and byteValue.
            ...
            //     cannot determine the final destination address at compile time. Thus, the node passed in to setmemoryEvaluator() will 
            //     have four children: dest, destOffset, len, and byteValue.
            //
            ...
            //destination address at compile time and only pass in three children to setmemoryEvaluator() (dest, len, byteValue) 
